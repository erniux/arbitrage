...
class Watchlist(tk.Frame):
    def __init__(self, binance_contracts: typing.Dict[str, Contract], bitmex_contracts: typing.Dict[str, Contract],
        ...
        self._binance_entry = tk.Entry(self._commands_frame, fg=FG_COLOR, justify=tk.CENTER,
                                       insertbackground=FG_COLOR_2, bg=BG_COLOR_2)
        ...
        for idx, h in enumerate(self._headers):
            header = tk.Label(self._table_frame, text=h.capitalize() if h != "eliminar" else "", bg=BG_COLOR,
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['remove'][b_index] = tk.Button(self._table_frame, text="X", bg=BG_CRED, fg=FG_COLOR_2,
